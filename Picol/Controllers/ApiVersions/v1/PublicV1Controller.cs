// -----------------------------------------------------------------------
// <copyright file="PublicV1Controller.cs" company="Washington State University">
// Copyright (c) Washington State University Board of Regents. All rights reserved.
// </copyright>
// -----------------------------------------------------------------------

namespace Picol.Controllers.V1
{
    using System;
    ...
    [System.Web.Mvc.RoutePrefix("api/v1/Public")]
    public class PublicV1Controller : ApiController
    {
        ...
        public Result<Classes.Api.V1.Application> GetApplications(string apiKey, bool acceptTos)
        {
            try
            {
                // Process TOS acceptance
                var result = new Result<Classes.Api.V1.Application>();
                if (!acceptTos)
                {
                    result.Error = true;
                ...
                var applications = (from r in dbContext.Applications
                                    select new Classes.Api.V1.Application
                                    {
                                        Id = r.Id,
                                        Name = r.Name,
                                        Code = r.Code
        ...
        public Result<Classes.Api.V1.Crop> GetCrops(string apiKey, bool acceptTos)
        {
            try
            {
                // Process TOS acceptance
                var result = new Result<Classes.Api.V1.Crop>();
                if (!acceptTos)
                {
                    result.Error = true;
                    result.Message = "You must accept the Terms of Service located on the Request API key page (~/Account/RequestApiKey) by setting acceptTos to true.";
                ...
                var crops = (from r in dbContext.Crops
                             select new Classes.Api.V1.Crop
                             {
                                 Id = r.Id,
                                 Name = r.Name,
                                 Code = r.Code,
        ...
        public Result<Classes.Api.V1.Ingredient> GetIngredients(string apiKey, bool acceptTos)
        {
            try
            {
                // Process TOS acceptance
                var result = new Result<Classes.Api.V1.Ingredient>();
                if (!acceptTos)
                {
                    result.Error = true;
                    result.Message = "You must accept the Terms of Service located on the Request API key page (~/Account/RequestApiKey) by setting acceptTos to true.";
                ...
                var ingredients = (from r in dbContext.Ingredients
                                   select new Classes.Api.V1.Ingredient
                                   {
                                       Id = r.Id,
                                       Name = r.Name,
                                       Code = r.Code,
                                       Notes = r.Notes,
                                       Resistance = new Classes.Api.V1.Resistance { Id = r.Resistance.Id, Code = r.Resistance.Code, MethodOfAction = r.Resistance.MethodOfAction, Source = r.Resistance.Source }
                                   }).OrderBy(x => x.Name).ToList();
        ...
        public Result<Classes.Api.V1.IntendedUser> GetIntendedUsers(string apiKey, bool acceptTos)
        {
            try
            {
                // Process TOS acceptance
                var result = new Result<Classes.Api.V1.IntendedUser>();
                if (!acceptTos)
                {
                    result.Error = true;
                    result.Message = "You must accept the Terms of Service located on the Request API key page (~/Account/RequestApiKey) by setting acceptTos to true.";
                ...
                var users = (from r in dbContext.IntendedUsers
                             select new Classes.Api.V1.IntendedUser
                             {
                                 Id = r.Id,
                                 Name = r.Name,
                                 Code = r.Code
        ...
        public Result<Classes.Api.V1.PesticideType> GetPesticideTypes(string apiKey, bool acceptTos)
        {
            try
            {
                // Process TOS acceptance
                var result = new Result<Classes.Api.V1.PesticideType>();
                if (!acceptTos)
                {
                    result.Error = true;
                    result.Message = "You must accept the Terms of Service located on the Request API key page (~/Account/RequestApiKey) by setting acceptTos to true.";
                ...
                var pesticideTypes = (from r in dbContext.PesticideTypes
                                      select new Classes.Api.V1.PesticideType
                                      {
                                          Id = r.Id,
                                          Name = r.Name,
                                          Code = r.Code
        ...
        public Result<Classes.Api.V1.Pest> GetPests(string apiKey, bool acceptTos)
        {
            try
            {
                // Process TOS acceptance
                var result = new Result<Classes.Api.V1.Pest>();
                if (!acceptTos)
                {
                    result.Error = true;
                    result.Message = "You must accept the Terms of Service located on the Request API key page (~/Account/RequestApiKey) by setting acceptTos to true.";
                ...
                var pests = (from r in dbContext.Pests
                             select new Classes.Api.V1.Pest
                             {
                                 Id = r.Id,
                                 Name = r.Name,
                                 Code = r.Code,
        ...
        public Result<Classes.Api.V1.Registrant> GetRegistrants(string apiKey, bool acceptTos)
        {
            try
            {
                // Process TOS acceptance
                var result = new Result<Classes.Api.V1.Registrant>();
                if (!acceptTos)
                {
                    result.Error = true;
                    result.Message = "You must accept the Terms of Service located on the Request API key page (~/Account/RequestApiKey) by setting acceptTos to true.";
                ...
                var registrants = (from r in dbContext.Registrants
                                   select new Classes.Api.V1.Registrant
                                   {
                                       Id = r.Id,
                                       Name = r.Name,
                                       Website = r.Url
        ...
        public Result<Classes.Api.V1.Resistance> GetResistances(string apiKey, bool acceptTos)
        {
            try
            {
                // Process TOS acceptance
                var result = new Result<Classes.Api.V1.Resistance>();
                if (!acceptTos)
                {
                    result.Error = true;
                    result.Message = "You must accept the Terms of Service located on the Request API key page (~/Account/RequestApiKey) by setting acceptTos to true.";
                ...
                var resistanceCodes = (from r in dbContext.Resistances
                                       select new Classes.Api.V1.Resistance
                                       {
                                           Id = r.Id,
                                           Source = r.Source,
                                           Code = r.Code,
        ...
        public Result<Classes.Api.V1.SignalWord> GetSignalWords(string apiKey, bool acceptTos)
        {
            try
            {
                // Process TOS acceptance
                var result = new Result<Classes.Api.V1.SignalWord>();
                if (!acceptTos)
                {
                    result.Error = true;
                    result.Message = "You must accept the Terms of Service located on the Request API key page (~/Account/RequestApiKey) by setting acceptTos to true.";
                ...
                var words = (from r in dbContext.SignalWords
                             select new Classes.Api.V1.SignalWord
                             {
                                 Id = r.Id,
                                 Name = r.Name,
                                 Code = r.Code
        ...
        public Result<Classes.Api.V1.State> GetStates(string apiKey, bool acceptTos)
        {
            try
            {
                // Process TOS acceptance
                var result = new Result<Classes.Api.V1.State>();
                if (!acceptTos)
                {
                    result.Error = true;
                    result.Message = "You must accept the Terms of Service located on the Request API key page (~/Account/RequestApiKey) by setting acceptTos to true.";
                ...
                var states = (from r in dbContext.States
                              select new Classes.Api.V1.State
                              {
                                  Id = r.Id,
                                  Name = r.Name
                              }).OrderBy(x => x.Name).ToList();
        ...
        public Result<Classes.Api.V1.Label> GetLabelsByCropId(string apiKey, int cropId, bool currentYear, int state, bool acceptTos)
        {
            try
            {
                // Process TOS acceptance
                var result = new Result<Classes.Api.V1.Label>();
                if (!acceptTos)
                {
                    result.Error = true;
                    result.Message = "You must accept the Terms of Service located on the Request API key page (~/Account/RequestApiKey) by setting acceptTos to true.";
                ...
                var labels = (from l in dataContext.Labels
                              ...
                              select new Classes.Api.V1.Label
                              {
                                  Id = l.Id,
                                  Name = l.Name,
                                  EpaNumber = l.Epa,
                                  IntendedUser = new Classes.Api.V1.IntendedUser { Id = l.IntendedUser.Id, Name = l.IntendedUser.Name, Code = l.IntendedUser.Code },
                                  Ingredients = l.IngredientLabelPairs.Select(x => new Classes.Api.V1.Ingredient { Id = x.Ingredient.Id, Name = x.Ingredient.Name, Code = x.Ingredient.Code, Notes = x.Ingredient.Notes, Resistance = new Classes.Api.V1.Resistance { Id = x.Ingredient.Resistance.Id, Code = x.Ingredient.Resistance.Code, MethodOfAction = x.Ingredient.Resistance.MethodOfAction, Source = x.Ingredient.Resistance.Source } }),
                                  PesticideTypes = l.PesticideTypes.Select(x => new Classes.Api.V1.PesticideType { Id = x.Id, Code = x.Code, Name = x.Name }),
                                  Registrant = new Classes.Api.V1.Registrant { Id = l.Registrant.Id, Name = l.Registrant.Name, Website = l.Registrant.Url },
                                  SlnName = l.SlnName,
                                  SlnExpiration = l.SlnExpiration.HasValue ? l.SlnExpiration.Value : DateTime.MinValue,
                                  StateRecords = l.StateRecords.Select(x => new Classes.Api.V1.StateRecord { Id = x.Id, StateId = x.StateId, Name = x.State.Name, AgencyId = x.AgencyId, Version = x.Version, Year = x.Year, I502 = x.I502, Essb6206 = x.Essb6206 }),
        ...
        /// <param name="acceptTos">if set to <c>true</c> [accept tos].</param>
        /// <returns>A JSON encoded collection of labels</returns>
        public Result<Classes.Api.V1.Label> GetLabelsByCropIds(string apiKey, int[] cropIds, bool currentYear, int state, bool acceptTos)
        {
            try
            {
                // Process TOS acceptance
        ...
        /// <param name="acceptTos">if set to <c>true</c> [accept tos].</param>
        /// <returns>A JSON encoded collection of labels</returns>
        public Result<Classes.Api.V1.Label> GetLabelsByEpa(string apiKey, string id, bool acceptTos)
        {
            try
            {
                // Process TOS acceptance
        ...
        /// <param name="acceptTos">if set to <c>true</c> [accept tos].</param>
        /// <returns>A JSON encoded collection of labels</returns>
        public Result<Classes.Api.V1.Label> GetLabelsByIngredientId(string apiKey, int ingredientId, bool currentYear, int state, bool acceptTos)
        {
            try
            {
                // Process TOS acceptance
        ...
        /// <param name="acceptTos">if set to <c>true</c> [accept tos].</param>
        /// <returns>A JSON encoded collection of labels</returns>
        public Result<Classes.Api.V1.Label> GetLabelsByIngredientIds(string apiKey, int[] ingredientIds, bool currentYear, int state, bool acceptTos)
        {
            try
            {
                // Process TOS acceptance
        ...
        /// <param name="acceptTos">if set to <c>true</c> [accept tos].</param>
        /// <returns>A JSON encoded collection of labels</returns>
        public Result<Classes.Api.V1.Label> GetLabelsByPestId(string apiKey, int pestId, bool currentYear, int state, bool acceptTos)
        {
            try
            {
                // Process TOS acceptance
        ...
        /// <param name="acceptTos">if set to <c>true</c> [accept tos].</param>
        /// <returns>A JSON encoded collection of labels</returns>
        public Result<Classes.Api.V1.Label> GetLabelsByPestIds(string apiKey, int[] pestIds, bool currentYear, int state, bool acceptTos)
        {
            try
            {
                // Process TOS acceptance
        ...
        /// <param name="acceptTos">if set to <c>true</c> [accept tos].</param>
        /// <returns>A JSON encoded collection of labels</returns>
        public Result<Classes.Api.V1.Label> GetLabelsByRegistrant(string apiKey, int registrantId, bool currentYear, int state, bool acceptTos)
        {
            try
            {
                // Process TOS acceptance
