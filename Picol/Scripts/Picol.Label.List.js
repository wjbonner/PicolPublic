...
$.Label = {
    ...
    Columns: [
        ...
        { id: "IntendedUser", name: "IntendedUser", field: "IntendedUser", sortable: true},
        { id: "Registrant", name: "Registrant", field: "Registrant", sortable: true },
        { id: "SignalWord", name: "SignalWord", field: "SignalWord", sortable: true },
                    ...
                    if (response.Labels.length == 0) {
                        ...
                        for (var i = 0; i < response.Labels.length; i++) {
                            $.Label.Data[i] = {
                                ...
                                "FormulationId": response.Labels[i]["FormulationId"],
                                "IntendedUser": response.Labels[i]["IntendedUser"],
                                "IntendedUserId": response.Labels[i]["IntendedUserId"],
                                "Registrant": response.Labels[i]["Registrant"],
                                "RegistrantId": response.Labels[i]["RegistrantId"],
                                "SignalWord": response.Labels[i]["SignalWord"],
                                "SignalWordId": response.Labels[i]["SignalWordId"],
                                "Usage": response.Labels[i]["Usage"],
                                "UsageId": response.Labels[i]["UsageId"],
                                "Actions": ""
                            };
                        }
