...
$.Application = {
    CookieName: "Picol.Search.Index.ApplicationGrid",
                    ...
                    if (response.Applications.length == 0) {
                        ...
                        for (var i = 0; i < response.Applications.length; i++) {
                            $.Application.Data[i] = {
                                ...
                                "Notes": response.Applications[i]["Notes"]
                            };
                        }
    ...
    InitializeGridPlugins: function () {
        ...
        $.Application.Grid.registerPlugin(new Slick.AutoTooltips());
    ...
    ResizeGridContainer: function () {
        $('#' + $.Application.GridContainer).height($(window).height() - $('#ApplicationFooter').height() - 5);
    }
