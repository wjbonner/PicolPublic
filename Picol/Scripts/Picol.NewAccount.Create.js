...
$(window).load(function () {
    ...
    $('#Email').keyup(function () {
        if ($('#Email').val().toLocaleLowerCase().indexOf("@wsu.edu") >= 0) {
            $("[data-password='true']").css('display', 'none');
            $("#WsuLoginNotice").css('display', 'unset');

        } else {
            $("[data-password='true']").css('display', 'unset');
            $("#WsuLoginNotice").css('display', 'none');
        }
    }).focus(function () {
    ...
    $('#Password_Hash').keyup(function () {
        PasswordStrength('Password_Hash');
        PasswordMatch('Password_Hash', 'PasswordConfirmation');
    }).focus(function () {
